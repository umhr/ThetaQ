package primitives
{
	 ...
	 */
	public class HemiSphereGeometry extends PrimitiveBase
	{
		 ...
		 */
		public function HemiSphereGeometry(radius:Number = 50, segmentsW:uint = 16, segmentsH:uint = 12, yUp:Boolean = true)
		{
			super();
